...
public class LimitRadius : MyBehaviour
{
    [Header("Limit Radius")]
    ...
    public virtual bool IsCollided()
    {
        ...
        //Check collide building
        //return this.collideObject.Count > 0;
    ...
    protected virtual void ClearObject(GameObject obj)
    {
    ...
    protected virtual void ResetColliderObject()
    {
